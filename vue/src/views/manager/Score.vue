      ...
      <el-table stripe :data="data.tableData" ref="tableRef">
        ...
        <el-table-column label="操作" align="center" width="200">
          <template #default="scope">
            <el-button type="primary" @click="handelEdit(scope.row)" v-if="data.user.role ==='ADMIN'">编辑</el-button>
            <el-button type="danger" @click="deleteSelect(scope.row.id)" v-if="data.user.role ==='ADMIN'">删除成绩</el-button>
