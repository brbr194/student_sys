<template >
  <div>
    <div class="card" style="margin-bottom: 10px;">
      <el-input  v-model="data.grade" :prefix-icon="Search" style="width: 250px; margin-right: 10px" placeholder="请输入年级进行查询"></el-input>
    ...
    <el-dialog title="新增或编辑年级信息" width="40%" v-model="data.formVisible" :close-on-click-modal="false" destroy-on-close>
      <el-form :model="data.form" label-width="150px" style="padding-right: 50px" ref="formRef">
        <el-form-item label="年级号：" prop="grade" required>
...
const save = () =>{
  formRef.value.validate((valid)=> {
    if (valid) {
      request.request({
        url: data.form.id ? '/grade/update' : '/grade/add',
